...
_Report generated by [`/claude-config:assess`](https://github.com/bjcoombs/claude-config). Install the plugin in any Claude Code session with:_
...
4. **PR body must include the plugin reference at the bottom** so reviewers can install the tool that generated the report. Use this body template:
   ...
   _Generated by [`/claude-config:assess`](https://github.com/bjcoombs/claude-config) — a Claude Code plugin for codebase readiness assessment with complexity hotspot heatmaps. Install in any Claude Code session:_
