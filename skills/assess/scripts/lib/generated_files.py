...
Filename globs (``EXCLUDE_FILE_PATTERNS`` in ``complexity-treemap.py``) miss a
generated file whose name looks ordinary, such as a schema dump or a font
...
# convention) is covered by the bare "do not edit" alternative.
_HEADER_MARKERS = re.compile(
    r"generated file|do not edit|@generated|this file is auto-generated"
    r"|autogenerated",
    re.IGNORECASE,
)
...
def average_line_length(path: Path) -> float:
    """Mean bytes per line; 0.0 for an empty or unreadable file.
