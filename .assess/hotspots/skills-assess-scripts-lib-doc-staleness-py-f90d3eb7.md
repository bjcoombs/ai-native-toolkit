...
|----------|-----|-----|---------|--------|
| 2026-06-04 | 245 | 69.0 | 7 | persistent |

## Briefing for editing this file

Use this briefing when about to modify `skills/assess/scripts/lib/doc_staleness.py`:

Hotspot (persistent). 245 LOC, max cyclomatic complexity 69.0, 7 commits in churn window. (Briefing refined by LLM via assess_finalize - see Suggested actions below.)
